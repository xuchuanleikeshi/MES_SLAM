...
public:
    ...
    //获取稀疏地图点
    std::set<MapPoint*> GetSparsifiedMapPoints();
    /**
     * @brief 获取地图中的所有参考地图点
     * 
    ...
    void AddSparsifiedMapPoint(MapPoint* pMP);
    void AddSparsifiedKeyFrame(KeyFrame* pKF);
...
protected:
    ...
    std::set<MapPoint*> mspSparsifiedMapPoints;
    std::set<KeyFrame*> mspSparsifiedKeyFrames;
